class ProductosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @producto.save
        format.html { redirect_to @producto, notice: "El producto fue creado." }
  ...
  def update
    respond_to do |format|
      if @producto.update(producto_params)
        format.html { redirect_to @producto, notice: "El producto fue actualizado." }
  ...
  def producto_params
    params.require(:producto)
      .permit(:nombre, :codigo, :existencia, :descripcion, :precio_de_compra,
              :iva, :type)
      .with_defaults(usuario: current_usuario)
