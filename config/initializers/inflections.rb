...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  # remplazos = { a: "as", e: "es", i: "is", o: "os", u: "us", d: "des", j: "jes", l: "les", n: "nes", r: "res", y: "yes", z: "ces", }

  inflect.plural(/(z|[a])(?=[A-Z]|_|$)/, "as")
  inflect.plural(/(z|[e])(?=[A-Z]|_|$)/, "es")
  inflect.plural(/(z|[i])(?=[A-Z]|_|$)/, "is")
  inflect.plural(/(z|[o])(?=[A-Z]|_|$)/, "os")
  inflect.plural(/(z|[u])(?=[A-Z]|_|$)/, "us")
  inflect.plural(/(z|[d])(?=[A-Z]|_|$)/, "des")
  inflect.plural(/(z|[j])(?=[A-Z]|_|$)/, "jes")
  inflect.plural(/(z|[l])(?=[A-Z]|_|$)/, "les")
  inflect.plural(/(z|[n])(?=[A-Z]|_|$)/, "nes")
  inflect.plural(/(z|[r])(?=[A-Z]|_|$)/, "res")
  inflect.plural(/(z|[y])(?=[A-Z]|_|$)/, "yes")
  inflect.plural(/(z|[z])(?=[A-Z]|_|$)/, "ces")
